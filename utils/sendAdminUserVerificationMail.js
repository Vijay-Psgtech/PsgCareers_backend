...
const sendAdminUserVerificationMail = async (email,token) => {
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <td align="center">
                    ...
                    <tr>
                        ...
                        <img src="http://careertest.psginstitutions.in/public/logo.png" alt="PSG Careers" style="height: 60px;" />
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: center;">
                        <h2 style="color: #333;">Welcome to PSG Careers</h2>
                        <p style="font-size: 16px; color: #555;">You have been added as an admin. Please verify and set your password by clicking the button below:</p>
...
module.exports = sendAdminUserVerificationMail;